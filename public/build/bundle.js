...
var app = (function () {
    ...
    /* src/YouTubeEmbed.svelte generated by Svelte v3.42.6 */

    const file$3 = "src/YouTubeEmbed.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(iframe.src, iframe_src_value = `https://www.youtube.com/embed/${/*id*/ ctx[0]}`)) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "title", "YouTube video player");
    			attr_dev(iframe, "frameborder", "0");
    			iframe.allowFullscreen = true;
    			attr_dev(iframe, "class", "svelte-1m3k37");
    			add_location(iframe, file$3, 6, 4, 143);
    			attr_dev(div0, "class", "wrap svelte-1m3k37");
    			set_style(div0, "--width", /*width*/ ctx[1]);
    			set_style(div0, "--height", /*height*/ ctx[2]);
    			add_location(div0, file$3, 5, 2, 75);
    			attr_dev(div1, "class", "parent svelte-1m3k37");
    			add_location(div1, file$3, 4, 0, 52);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*id*/ 1 && !src_url_equal(iframe.src, iframe_src_value = `https://www.youtube.com/embed/${/*id*/ ctx[0]}`)) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	validate_slots('YouTubeEmbed', slots, []);
    	let { id, width, height } = $$props;
    	const writable_props = ['id', 'width', 'height'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<YouTubeEmbed> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ id, width, height });
    ...
    class YouTubeEmbed extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$3(this, options, instance$3, create_fragment$3, safe_not_equal, { id: 0, width: 1, height: 2 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "YouTubeEmbed",
    			options,
    			id: create_fragment$3.name
    		});
    		...
    		if (/*id*/ ctx[0] === undefined && !('id' in props)) {
    			console.warn("<YouTubeEmbed> was created without expected prop 'id'");
    		}

    		if (/*width*/ ctx[1] === undefined && !('width' in props)) {
    			console.warn("<YouTubeEmbed> was created without expected prop 'width'");
    		}

    		if (/*height*/ ctx[2] === undefined && !('height' in props)) {
    			console.warn("<YouTubeEmbed> was created without expected prop 'height'");
    		}
    	}

    	get id() {
    		throw new Error("<YouTubeEmbed>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set id(value) {
    		throw new Error("<YouTubeEmbed>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src/Carousel.svelte generated by Svelte v3.42.6 */
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "•\n      ";
    			attr_dev(button, "class", "switch-btn svelte-rtumhs");
    			toggle_class(button, "active", /*openVideo*/ ctx[1] === /*i*/ ctx[7]);
    			add_location(button, file$2, 18, 6, 646);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*switchVideo*/ ctx[2](/*i*/ ctx[7]), false, false, false);
    				mounted = true;
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(18:4) {#each videos as _, i}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	const youtubeembed_spread_levels = [/*videos*/ ctx[0][/*openVideo*/ ctx[1]]];
    	let youtubeembed_props = {};

    	for (let i = 0; i < youtubeembed_spread_levels.length; i += 1) {
    		youtubeembed_props = assign(youtubeembed_props, youtubeembed_spread_levels[i]);
    	}

    	youtubeembed = new YouTubeEmbed({
    			props: youtubeembed_props,
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "←";
    			t1 = space();
    			create_component(youtubeembed.$$.fragment);
    			t2 = space();
    			...
    			attr_dev(button0, "class", "prev svelte-rtumhs");
    			add_location(button0, file$2, 13, 2, 438);
    			attr_dev(button1, "class", "next svelte-rtumhs");
    			add_location(button1, file$2, 15, 2, 535);
    			attr_dev(div0, "class", "switcher svelte-rtumhs");
    			add_location(div0, file$2, 16, 2, 590);
    			attr_dev(div1, "class", "carousel svelte-rtumhs");
    			add_location(div1, file$2, 12, 0, 413);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, t1);
    			mount_component(youtubeembed, div1, null);
    			append_dev(div1, t2);
    		...
    		p: function update(ctx, [dirty]) {
    			const youtubeembed_changes = (dirty & /*videos, openVideo*/ 3)
    			? get_spread_update(youtubeembed_spread_levels, [get_spread_object(/*videos*/ ctx[0][/*openVideo*/ ctx[1]])])
    			: {};

    			youtubeembed.$set(youtubeembed_changes);

    			if (dirty & /*openVideo, switchVideo, videos*/ 7) {
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(youtubeembed.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(youtubeembed.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    			destroy_component(youtubeembed);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { videos } = $$props;
    	const switchVideo = i => e => $$invalidate(1, openVideo = i);

    	const prev = e => openVideo === 0
    	? $$invalidate(1, openVideo = videos.length - 1)
    	: $$invalidate(1, openVideo--, openVideo);

    	const next = e => openVideo === videos.length - 1
    	? $$invalidate(1, openVideo = 0)
    	: $$invalidate(1, openVideo++, openVideo);
    	...
    	$$self.$inject_state = $$props => {
    		if ('videos' in $$props) $$invalidate(0, videos = $$props.videos);
    		if ('openVideo' in $$props) $$invalidate(1, openVideo = $$props.openVideo);
    	};
    	...
    	$$invalidate(1, openVideo = 0);
    	return [videos, openVideo, switchVideo, prev, next];
    }

    class Carousel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$3(this, options, instance$2, create_fragment$2, safe_not_equal, { videos: 0 });
    		...
    		if (/*videos*/ ctx[0] === undefined && !('videos' in props)) {
    			console.warn("<Carousel> was created without expected prop 'videos'");
    		}
    	}
...
香港'.split(' ');
    ...
    */
    ...
    var linkify__namespace = /*#__PURE__*/_interopNamespace$1(linkifyjs);
    ...
    */
    ...
    var linkifyHtml_1 = linkifyHtml$1;

    var linkifyHtml = linkifyHtml_1;

    /* src/Events.svelte generated by Svelte v3.42.6 */
    ...
    // (38:2) {#each events as { title, date, address, description }}
    function create_each_block$1(ctx) {
    	...
    	let p1;
    	let a;
    	let t4_value = /*address*/ ctx[6] + "";
    	let t4;
    	let t5;
    	let p2;
    	let raw_value = linkifyHtml(/*description*/ ctx[7]) + "";
    	let t6;
    	...
    	const block = {
    		c: function create() {
    			...
    			p2 = element("p");
    			t6 = space();
    			add_location(h4, file$1, 39, 6, 1442);
    			add_location(p0, file$1, 40, 6, 1465);
    			attr_dev(a, "href", /*addressToLink*/ ctx[0](/*address*/ ctx[6]));
    			add_location(a, file$1, 41, 9, 1488);
    			add_location(p1, file$1, 41, 6, 1485);
    			add_location(p2, file$1, 42, 6, 1545);
    			attr_dev(div, "class", "event svelte-1akibxw");
    			add_location(div, file$1, 38, 4, 1416);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:2) {#each events as { title, date, address, description }}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "events svelte-1akibxw");
    			add_location(div, file$1, 36, 0, 1333);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*linkifyHtml, events, addressToLink*/ 3) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const addressToLink = address => `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(address)}`;

    	const barbesInfo = {
    		title: "Live at Barbès",
    		address: "376 9th St. corner of 6th Ave, Park Slope, Brooklyn",
    		description: "Gordon Lockwood live at Barbès: https://www.barbesbrooklyn.com/events"
    	};

    	const terraBluesInfo = {
    		title: "Live at Terra Blues",
    		address: "149 Bleecker St., Manhattan",
    		description: "Gordon Lockwood live at Terra Blues: https://www.terrablues.com/events"
    	};

    	const events = [
    		{
    			...terraBluesInfo,
    			date: "Thursday March 31 7-10 pm"
    		},
    		{
    			...barbesInfo,
    			date: "Friday April 22 8pm"
    		},
    		{
    			...terraBluesInfo,
    			date: "Thursday April 28 7-10 pm"
    		},
    		{
    			...terraBluesInfo,
    			date: "Thursday May 19 7-10 pm"
    		},
    		{
    			...barbesInfo,
    			date: "Saturday May 21 6pm"
    		},
    		{
    			...terraBluesInfo,
    			date: "Thursday June 2 7-10 pm"
    		},
    		{
    			...barbesInfo,
    			title: "Saturday afternoon residency at Barbès in July each week at 6pm",
    			date: "Saturdays July 4, 11, 18, 25 at 6 pm",
    			description: "Gordon Lockwood live at Barbès every Saturday in July: https://www.barbesbrooklyn.com/events"
    		}
    	];
    ...
    // (94:6) {#each socials as { href, image }}
    function create_each_block(ctx) {
    	let li;
    	let a;
    	let img;
    	let t;
    	let img_levels = [/*image*/ ctx[4]];
    	let img_data = {};
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(img, "svelte-1bky7aq", true);
    			add_location(img, file, 97, 12, 2766);
    			attr_dev(a, "href", /*href*/ ctx[3]);
    			attr_dev(a, "class", "svelte-1bky7aq");
    			add_location(a, file, 95, 10, 2685);
    			add_location(li, file, 94, 8, 2670);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			set_attributes(img, img_data = get_spread_update(img_levels, [/*image*/ ctx[4]]));
    			toggle_class(img, "svelte-1bky7aq", true);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(94:6) {#each socials as { href, image }}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let ul;
    	let current;
    	let img0_levels = [/*images*/ ctx[1][0]];
    	let img0_data = {};

    	for (let i = 0; i < img0_levels.length; i += 1) {
    		img0_data = assign(img0_data, img0_levels[i]);
    	}

    	carousel = new Carousel({
    			props: { videos: /*videos*/ ctx[0] },
    			$$inline: true
    		});

    	let img1_levels = [/*images*/ ctx[1][1]];
    	let img1_data = {};

    	for (let i = 0; i < img1_levels.length; i += 1) {
    		img1_data = assign(img1_data, img1_levels[i]);
    	}

    	let img2_levels = [/*images*/ ctx[1][2]];
    	let img2_data = {};

    	for (let i = 0; i < img2_levels.length; i += 1) {
    		img2_data = assign(img2_data, img2_levels[i]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "Gordon Lockwood";
    			t1 = space();
    			img0 = element("img");
    			t2 = space();
    			...
    			div0 = element("div");
    			h20 = element("h2");
    			h20.textContent = "Gordon Lockwood LIVE at Barbés Brooklyn";
    			t4 = space();
    			create_component(carousel.$$.fragment);
    			t5 = space();
    			p0 = element("p");
    			p0.textContent = "Jeremiah Lockwood and Ricky Gordon have been making music together for over\n    two decades, originally as disciples of Piedmont Blues legend Carolina Slim.\n    For their first post-pandemic live shows they have begun a new duo to share\n    the sonic pleasures stored up over a tumultuous year of longing. Expect old\n    time blues, new-time rhythms, and ballads about all the things we want to do\n    with you.";
    			t7 = space();
    			h21 = element("h2");
    			h21.textContent = "About the artists";
    			t9 = space();
    			section2 = element("section");
    			div1 = element("div");
    			h30 = element("h3");
    			h30.textContent = "Jeremiah Lockwood";
    			t11 = space();
    			p1 = element("p");
    			p1.textContent = "Singer/guitarist Jeremiah Lockwood is the founder of The Sway Machinery,\n        a world-exploring, genre-defying band perhaps best known for its\n        collaborations with the late great Khaira Arby of Timbuktu.";
    			t13 = space();
    			img1 = element("img");
    			t14 = space();
    			...
    			div2 = element("div");
    			h31 = element("h3");
    			h31.textContent = "Ricky \"Dirty Red\" Gordon";
    			t17 = space();
    			p2 = element("p");
    			p2.textContent = "Drummer Ricky Gordon is a member of the Wynton Marsalis Ensemble and a\n        prolific composer for the screen, including iconic collaborations with\n        Spike Lee.";
    			t19 = space();
    			h22 = element("h2");
    			h22.textContent = "Events";
    			t21 = space();
    			...
    			h23 = element("h2");
    			h23.textContent = "Contact us!";
    			t24 = space();
    			h32 = element("h3");
    			a = element("a");
    			a.textContent = "jeremiahdaniellockwood@yahoo.com";
    			t26 = space();
    			ul = element("ul");
    			...
    			attr_dev(h1, "class", "svelte-1bky7aq");
    			add_location(h1, file, 30, 4, 823);
    			set_attributes(img0, img0_data);
    			toggle_class(img0, "svelte-1bky7aq", true);
    			add_location(img0, file, 32, 4, 902);
    			attr_dev(section0, "id", "top");
    			attr_dev(section0, "class", "svelte-1bky7aq");
    			add_location(section0, file, 29, 2, 800);
    			attr_dev(h20, "class", "svelte-1bky7aq");
    			add_location(h20, file, 37, 6, 978);
    			attr_dev(div0, "class", "svelte-1bky7aq");
    			add_location(div0, file, 36, 4, 966);
    			attr_dev(section1, "id", "media");
    			attr_dev(section1, "class", "svelte-1bky7aq");
    			add_location(section1, file, 35, 2, 941);
    			attr_dev(p0, "class", "about-para svelte-1bky7aq");
    			add_location(p0, file, 42, 2, 1082);
    			attr_dev(h21, "class", "svelte-1bky7aq");
    			add_location(h21, file, 51, 2, 1531);
    			attr_dev(h30, "class", "svelte-1bky7aq");
    			add_location(h30, file, 55, 6, 1612);
    			add_location(p1, file, 56, 6, 1645);
    			attr_dev(div1, "class", "svelte-1bky7aq");
    			add_location(div1, file, 54, 4, 1600);
    			set_attributes(img1, img1_data);
    			toggle_class(img1, "svelte-1bky7aq", true);
    			add_location(img1, file, 63, 4, 1947);
    			attr_dev(section2, "class", "about svelte-1bky7aq");
    			attr_dev(section2, "id", "about");
    			add_location(section2, file, 53, 2, 1561);
    			set_attributes(img2, img2_data);
    			toggle_class(img2, "svelte-1bky7aq", true);
    			add_location(img2, file, 68, 4, 2064);
    			attr_dev(h31, "class", "svelte-1bky7aq");
    			add_location(h31, file, 70, 6, 2103);
    			add_location(p2, file, 71, 6, 2143);
    			attr_dev(div2, "class", "svelte-1bky7aq");
    			add_location(div2, file, 69, 4, 2091);
    			attr_dev(section3, "class", "about svelte-1bky7aq");
    			add_location(section3, file, 66, 2, 1986);
    			attr_dev(h22, "class", "svelte-1bky7aq");
    			add_location(h22, file, 79, 2, 2362);
    			attr_dev(section4, "id", "events");
    			attr_dev(section4, "class", "svelte-1bky7aq");
    			add_location(section4, file, 81, 2, 2381);
    			attr_dev(h23, "class", "svelte-1bky7aq");
    			add_location(h23, file, 86, 4, 2447);
    			attr_dev(a, "href", "mailto:jeremiahdaniellockwood@yahoo.com");
    			attr_dev(a, "class", "svelte-1bky7aq");
    			add_location(a, file, 88, 6, 2483);
    			attr_dev(h32, "class", "svelte-1bky7aq");
    			add_location(h32, file, 87, 4, 2472);
    			attr_dev(ul, "class", "socials svelte-1bky7aq");
    			add_location(ul, file, 92, 4, 2600);
    			attr_dev(footer, "class", "svelte-1bky7aq");
    			add_location(footer, file, 85, 2, 2434);
    			attr_dev(main, "class", "svelte-1bky7aq");
    			add_location(main, file, 28, 0, 791);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(events, section4, null);
    			append_dev(main, t22);
    			append_dev(main, footer);
    			append_dev(footer, h23);
    			append_dev(footer, t24);
    			append_dev(footer, h32);
    			append_dev(h32, a);
    		...
    		p: function update(ctx, [dirty]) {
    			set_attributes(img0, img0_data = get_spread_update(img0_levels, [/*images*/ ctx[1][0]]));
    			toggle_class(img0, "svelte-1bky7aq", true);
    			set_attributes(img1, img1_data = get_spread_update(img1_levels, [/*images*/ ctx[1][1]]));
    			toggle_class(img1, "svelte-1bky7aq", true);
    			set_attributes(img2, img2_data = get_spread_update(img2_levels, [/*images*/ ctx[1][2]]));
    			toggle_class(img2, "svelte-1bky7aq", true);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const images = [
    		{ src: "/images/graphic.webp", alt: "" },
    		{
    			src: "/images/lockwood.jpg",
    			alt: "Jeremiah Lockwood"
    		},
    		{
    			src: "/images/gordon.jpg",
    			alt: 'Ricky "Dirty Red" Gordon'
    		}
    	];

    	const socials = [
    		{
    			href: "https://www.youtube.com/channel/UC8ve7pvyF9rQMX02fBXgTsw",
    			image: {
    		...
    		{
    			href: "https://www.facebook.com/jeremiah.lockwood",
    			image: {
